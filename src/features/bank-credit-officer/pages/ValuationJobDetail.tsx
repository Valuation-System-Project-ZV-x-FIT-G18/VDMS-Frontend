...
const ValuationJobDetail = ({ projectId, initialProject, onBack }: ValuationJobDetailProps) => {
  ...
  const [selectedUploadDocId, setSelectedUploadDocId] = useState<string | null>(
    null,
  );
    ...
    const fetchProjectDetails = async () => {
      try {
        ...
        if (initialProject) {
          ...
          try {
            projectData = await projectService.getOne(projectId);
          } catch {
          ...
          <div style={cardStyle}>
            ...
            <div style={detailsGridStyle}>
              ...
              <div style={detailCellStyle}>
                ...
                <div style={detailValueStyle}>
                  <a
                    href={`tel:${jobData.applicantContact}`}
                    style={{
                  ...
                  <div>
                    ...
                    {doc.note && (
                      <div
                        style={{
                          fontSize: "11px",
                          color: doc.required ? "#ff4d4f" : "#fa8c16",
                        }}
                      >
                        {doc.note}
                      </div>
