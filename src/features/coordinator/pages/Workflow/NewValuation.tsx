...
const NewValuation: React.FC = () => {
  ...
  const [valuationType, setValuationType] = useState<'initial' | 'revaluation'>('initial');
  ...
  const handleContinue = (e: React.MouseEvent) => {
    ...
    if (validateForm()) {
      ...
      const firstError = document.querySelector('.has-error, .error-msg, .input-error');
      if (firstError) {
      ...
      <div className="content">
        ...
        <div className="grid">
          ...
          <section className="panel">
            <div className="id-card">
              <div className="id-card__icon">
                <svg viewBox="0 0 24 24" width="22" height="22">
                  <path d="M8 3h6l3 3v15a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2Z" strokeWidth="2" stroke="currentColor" fill="none" />
                  <path d="M9 12h6M9 16h6" strokeWidth="2" stroke="currentColor" fill="none" />
                </svg>
              </div>
              <div>
                <div className="id-line"><strong>Project ID</strong><span>:</span><span className="value">{projectId}</span></div>
                <div className="id-line"><strong>Valuation ID</strong><span>:</span><span className="value">{valuationId}</span></div>
              </div>
            </div>
            ...
            {priorityError && <div className="error-msg priority-error">{priorityError}</div>}
            ...
            {dateError && <div className="error-msg date-error">{dateError}</div>}
          ...
          <section>
            <div className="uploads" id="uploadsContainer">
              ...
              <div className="upload-group" data-required="true">
                ...
                <div className={`drop ${deed1Error ? 'has-error' : ''} ${deed1 ? 'has-file' : ''}`} id="drop1">
                  {deed1 ? (
                    <div className="file-info">
                      <span className="file-name">{deed1Name}</span>
                      <button 
                        className="file-remove" 
                        onClick={() => handleRemoveFile(setDeed1, setDeed1Name, setDeed1Error, deed1Ref, true)}
                      >
                        ✕
                      </button>
                    </div>
                    ...
                    <div className="drop-inner">
                      <svg viewBox="0 0 24 24" width="22" height="22">
                        <path d="M12 16V6m0 0l-3 3m3-3l3 3" fill="none" stroke="#9aa6b2" strokeWidth="2" />
                        <path d="M4 16v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2" fill="none" stroke="#9aa6b2" strokeWidth="2" />
                      </svg>
                  ...
                  <input 
                    ...
                    onChange={(e) => handleFileChange(e, setDeed1, setDeed1Name, setDeed1Error, true)}
              ...
              <div className="upload-group" data-required="true">
                ...
                <div className={`drop ${deed2Error ? 'has-error' : ''} ${deed2 ? 'has-file' : ''}`} id="drop2">
                  {deed2 ? (
                    <div className="file-info">
                      <span className="file-name">{deed2Name}</span>
                      <button 
                        className="file-remove" 
                        onClick={() => handleRemoveFile(setDeed2, setDeed2Name, setDeed2Error, deed2Ref, true)}
                      >
                        ✕
                      </button>
                    </div>
                  ...
                  <input 
                    ...
                    type="file" 
                    className="file-input" 
                    onChange={(e) => handleFileChange(e, setDeed2, setDeed2Name, setDeed2Error, true)}
                    accept=".pdf,.jpg,.jpeg,.png"
                  />
                </div>
                ...
                <div className={`drop ${deed3 ? 'has-file' : ''}`} id="drop3">
                  {deed3 ? (
                    <div className="file-info">
                      ...
                      <button 
                        className="file-remove" 
                        onClick={() => handleRemoveFile(setDeed3, setDeed3Name, () => {}, deed3Ref, false)}
                      >
                        ✕
                      </button>
                    </div>
                  ...
                  <input 
                    ...
                    type="file" 
                    className="file-input" 
                    onChange={(e) => handleFileChange(e, setDeed3, setDeed3Name, () => {}, false)}
                    accept=".pdf,.jpg,.jpeg,.png"
                  />
                </div>
              </div>
                ...
                <div className={`drop ${deed4 ? 'has-file' : ''}`} id="drop4">
                  {deed4 ? (
                    <div className="file-info">
                      ...
                      <button 
                        className="file-remove" 
                        onClick={() => handleRemoveFile(setDeed4, setDeed4Name, () => {}, deed4Ref, false)}
                      >
                        ✕
                      </button>
                    </div>
                  ...
                  <input 
                    ...
                    type="file" 
                    className="file-input" 
                    onChange={(e) => handleFileChange(e, setDeed4, setDeed4Name, () => {}, false)}
                    accept=".pdf,.jpg,.jpeg,.png"
                  />
                </div>
              </div>
              ...
              <div className="upload-group" style={{ gridColumn: '1/-1' }} data-required="true">
                <div className="upload-title">
                  <svg viewBox="0 0 24 24" width="18" height="18">
                    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" strokeWidth="2" stroke="currentColor" fill="none" />
                    <path d="M14 2v6h6" strokeWidth="2" stroke="currentColor" fill="none" />
                ...
                <div className={`drop big ${additionalDocError ? 'has-error' : ''} ${additionalDoc ? 'has-file' : ''}`} id="drop5">
                  {additionalDoc ? (
                    <div className="file-info">
                      <span className="file-name">{additionalDocName}</span>
                      <button 
                        className="file-remove" 
                        onClick={() => handleRemoveFile(setAdditionalDoc, setAdditionalDocName, setAdditionalDocError, additionalDocRef, true)}
                      >
                        ✕
                      </button>
                    </div>
                  ...
                  <input 
                    ...
                    type="file" 
                    className="file-input" 
                    onChange={(e) => handleFileChange(e, setAdditionalDoc, setAdditionalDocName, setAdditionalDocError, true)}
                    accept=".pdf,.jpg,.jpeg,.png"
                  />
                </div>
                {additionalDocError && <div className="error-msg">{additionalDocError}</div>}
              </div>
            </div>
            ...
            <div className="footer-actions">
              ...
              <div className="request" onClick={handleRequestMissing}>
                <svg viewBox="0 0 24 24" width="16" height="16">
                  <path d="M4 4h16v16H4V4zm0 4l8 5 8-5" fill="none" stroke="#111827" strokeWidth="2" />
                </svg>
                Request Missing
              </div>
              <button className="btn btn--primary" onClick={handleContinue}>
                <svg viewBox="0 0 24 24" width="16" height="16">
                  <path d="M20 6L9 17l-5-5" stroke="#fff" strokeWidth="3" fill="none" />
                </svg>
                Continue
              </button>
            </div>
